    ...
    <article style=" padding:1.5% 5% 0% 5%;">
     ...
     <div style="display: flex; align-items: center; justify-content: space-between;" class="Container_Filtro">
      <div class="Container_files">
       ...
       <form action="../mvc/TransaccionMVC/ListarTransaccionesFiltroController.php" method="GET">
        <select style="border: none; padding: 3px 7px;" id="opciones" name="value" onchange="this.form.submit()">
            ...
            <option value="500">Mostrar todo</option>
        </select>
        </form>
       </div>
    ...
    <tr style="color:gray;  ">
      ...
      <td style="display: flex; justify-content: center; gap: 10px; padding: 10px 0px; ">
        <button style="background-color: #ffcb66 ; padding:8px 10px;  border: none; border-radius: 4px;">
         ...
         <a href="../mvc/TransaccionMVC/EliminarTransaccionController.php?ID_TRANSACCION=<?php echo $Transaccion['ID_TRANSACCION']; ?>">
