...
?>
    <div class="productos-accion marco">
        ...
        <form action="../mvc/lista-ProductosMVC/ListaProductosControll.php" method="post" id="form-option-user" enctype="multipart/form-data" >
            <div class="fila-2">
        ...
        <div class="fila-3">
            <?php
            if(isset($_GET['IDU'])){
                echo '<input type="hidden" name="iduser" value="'.$usuarioInf['IDUSUARIO'].'">';
