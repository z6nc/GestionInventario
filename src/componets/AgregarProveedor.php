<section style="background-color: whitesmoke; ">
  ...
  <form class="shadows" action="../mvc/AgregarProveedorMVC/AgregarProveedorController.php" method="POST">
    <div style="background-color: #16a085;">
      <h1 style=" margin-top: 20px;color: white; padding-left: 20px; ">REGISTRAR NUEVO PROVEEDOR</h1>
    </div>
    <div class="" style="padding: 23px 15px;  display: flex;  flex-wrap: wrap; gap: 25px; text-align: center;">
      <div class="" style="display: flex; align-items: center;  flex: 1 1 400px; gap: 9px;">
        ...
        <input style="padding: 3px 3px; font-size: 17px;" type="text"  name="NomProveedor" required>
      </div>
      <div style="display: flex; align-items: center;   flex: 1 1 400px; gap: 9px;">
        ...
        <input style="padding: 3px 3px; font-size: 17px;" type="text" name="RucProveedor" required >
      </div>
