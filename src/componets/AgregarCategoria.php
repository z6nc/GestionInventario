<section style="background-color: whitesmoke; ">
  ...
  <form class="shadows" action="../mvc/CategoriasMVC/AgregarCategoriasController.php" method="POST">
    <div style="background-color: #16a085;">
      <h1 style=" margin-top: 20px;color: white; padding-left: 20px; ">REGISTRAR NUEVA CATEGORIA</h1>
    </div>
